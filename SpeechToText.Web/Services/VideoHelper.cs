...
namespace SpeechToText.Web.Services
{
    public static class VideoHelper
    {
        public static Nullable<TimeSpan> GetDuration(string filePath)
        {
            //Create varriables

            string ffMPEG = System.IO.Path.Combine("C:\\Development tools\\ffmpeg\\bin", "ffMPEG.exe");
