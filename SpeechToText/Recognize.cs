...
namespace SpeechToText
{
    ...
    {
        public static object Rec(string filePath, int bitRate,
        ...
        public static string SyncRecognize(string filePath)
        {
            ...
            foreach (var result in response.Results)
            {
                foreach (var alternative in result.Alternatives)
                {
                    sbResult.Append(alternative.Transcript);
                }
            }
        ...
        public static object SyncRecognizeWords(string filePath)
        {
            var speech = SpeechClient.Create();
            var response = speech.Recognize(new RecognitionConfig()
            {
        ...
        public static object SyncRecognizePunctuation(string filePath)
        {
            var speech = SpeechClient.Create();
            var response = speech.Recognize(new RecognitionConfig()
            {
        ...
        public static object SyncRecognizeModelSelection(string filePath, string model)
        {
            var speech = SpeechClient.Create();
            var response = speech.Recognize(new RecognitionConfig()
            {
        ...
        public static object SyncRecognizeEnhancedModel(string filePath)
        {
            var speech = SpeechClient.Create();
            var response = speech.Recognize(new RecognitionConfig()
            {
        ...
        public static object SyncRecognizeMultipleChannels(string filePath, int channelCount)
        {
        ...
        /// </summary>
        public static List<string> ReadPhrases()
        {
        ...
        public static object RecognizeWithContext(string filePath, IEnumerable<string> phrases)
        {
            var speech = SpeechClient.Create();
        ...
        public static object SyncRecognizeWithCredentials(string filePath, string credentialsFilePath)
        {
        ...
        public static object SyncRecognizeGcs(string storageUri)
        {
            var speech = SpeechClient.Create();
            var response = speech.Recognize(new RecognitionConfig()
            {
        ...
        public static string AsyncRecognizeGcs(string storageUri)
        {
            var speech = SpeechClient.Create();
            var sbResult = new StringBuilder();
            var longOperation = speech.LongRunningRecognize(new RecognitionConfig()
        ...
        public static object AsyncRecognizeGcsWords(string storageUri)
        {
            var speech = SpeechClient.Create();
            var longOperation = speech.LongRunningRecognize(new RecognitionConfig()
            {
        ...
        public static async Task<object> StreamingRecognizeAsync(string filePath)
        {
            var speech = SpeechClient.Create();
